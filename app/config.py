...
class Settings:
    ...
    # Tradejini data account (for premium WS feed) — REQUIRED for SHADOW mode
    tradejini_data_api_key: str = os.getenv("TRADEJINI_DATA_API_KEY", "")
    tradejini_data_password: str = os.getenv("TRADEJINI_PASSWORD", "")
    tradejini_data_totp_secret: str = os.getenv("TRADEJINI_TOTP", "")
